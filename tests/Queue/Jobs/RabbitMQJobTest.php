...
namespace Jiyis\Queue\Tests\Queue\Jobs;
...
class RabbitMQJobTest extends TestCase
{
    ...
    {
        $rc = new \ReflectionClass(NsqJob::class);
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|NsqQueue|NsqQueue
     */
    private function createRabbitMQQueueMock()
    {
        return $this->createMock(NsqQueue::class);
    }
}
